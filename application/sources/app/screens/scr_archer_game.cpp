...
#define BUMBUM_SIZE_I_X				(15)
#define BUMBUM_SIZE_I_Y				(15)
#define BUMBUM_SIZE_II_X			(10)
#define BUMBUM_SIZE_II_Y			(10)

// Setup
uint8_t setup;
//ARCHERY
int ARCHERY_x  = 1, ARCHERY_y = 20;
// Arrow
...
// Bitmap
	...
	static const unsigned char PROGMEM epd_bitmap_icon_BUMBUM_1 [] = {
	...
	static const unsigned char PROGMEM epd_bitmap_icon_BUMBUM_2 [] = {
	...
	static const unsigned char PROGMEM epd_bitmap_icon_BUMBUM_3 [] = {
...
void view_scr_archer_game() {
    ...
    // ARCHERY Animation
	if (count_arrow == 0) {
		view_render.drawBitmap(ARCHERY_x, ARCHERY_y, ARCHERY_icon_2, ARCHERY_SIZE_X, ARCHERY_SIZE_Y, WHITE);
	}
	else {
		view_render.drawBitmap(ARCHERY_x, ARCHERY_y, ARCHERY_icon_1, ARCHERY_SIZE_X, ARCHERY_SIZE_Y, WHITE);
	}
	...
	for (int i = 0; i < 5; i++) {
		...
		// Arrows
		if (arrow_id[i] == 1) {
			view_render.drawBitmap(arrow_x[i], arrow_y[i], epd_bitmap_icon_arrow, ARROW_SIZE_X, ARROW_SIZE_Y, WHITE);
		}
		...
		if (mine_id[i] == 1 && mine_bumbum[i] < 2) {
			view_render.drawBitmap(mine_x[i]-5, mine_y[i]+2, epd_bitmap_icon_BUMBUM_1, BUMBUM_SIZE_I_X , BUMBUM_SIZE_I_Y , WHITE);
		}
		else if (mine_id[i] == 1 && mine_bumbum[i] < 3) {
			view_render.drawBitmap(mine_x[i]-5, mine_y[i]+2, epd_bitmap_icon_BUMBUM_2, BUMBUM_SIZE_I_X , BUMBUM_SIZE_I_Y , WHITE);
		}
		else if (mine_id[i] == 1 && mine_bumbum[i] < 4) {
			view_render.drawBitmap(mine_x[i]-3, mine_y[i]+1, epd_bitmap_icon_BUMBUM_3, BUMBUM_SIZE_II_X, BUMBUM_SIZE_II_Y, WHITE);
			mine_id[i] = 0;
