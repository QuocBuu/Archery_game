...
// 'icon_vuong_mien', 60x20px
static const unsigned char PROGMEM epd_bitmap_icon_vuong_mien [] = {
...
void view_scr_charts_game() {
    ...
    view_render.drawBitmap(35, 5, epd_bitmap_icon_vuong_mien, 60, 20, 0);
...
void scr_charts_game_handle(ak_msg_t* msg) {
	...
	case AC_DISPLAY_BUTON_UP_LONG_PRESSED: {
		...
		eeprom_write(6,  (uint8_t*)&score_1st_R, 	4U);
		eeprom_write(10, (uint8_t*)&score_2nd_R, 	4U);
		eeprom_write(14, (uint8_t*)&score_3rd_R, 	4U);
	}
		BUZZER_PlayTones(tones_cc);
		break;
